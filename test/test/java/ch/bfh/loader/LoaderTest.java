...
public class LoaderTest extends ApplicationTest {
    /**
     * used to initialize the required objects
     *
     * @param stage a stage not required for this test
     */
    @Override
    ...
    /**
     * tests if the game can be loaded
     *
    ...
    /**
     * tests if the Settings can be loaded
     *
     * @throws JAXBException         if an error from jaxb occurs
     * @throws FileNotFoundException if the specified file was not found
     */
